...
| branch | build status |
| ---    | ---          |
| master | [![master status](https://gitlab.oit.duke.edu/stingar/hpfeeds-logger/badges/master/pipeline.svg)](https://gitlab.oit.duke.edu/stingar/hpfeeds-logger/commits/master)|
